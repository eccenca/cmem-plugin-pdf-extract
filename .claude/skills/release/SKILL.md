...
# Releasing cmem-plugin-pdf-extract
...
Then watch the publish workflow at https://github.com/eccenca/cmem-plugin-pdf-extract/actions and confirm the
new version appeared on [PyPI](https://pypi.org/project/cmem-plugin-pdf-extract/).
